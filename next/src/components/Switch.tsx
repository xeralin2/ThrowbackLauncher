export function Switch({
  ...
  return (
    ...
    >
      ...
      >
        <span
          className={`absolute left-[2px] top-1/2 size-[12px] -translate-y-1/2 rounded-[3px] shadow-[0_1px_2px_rgba(0,0,0,0.45)] transition-[translate,scale,background-color] duration-200 ease-out group-active:scale-x-[1.25] ${

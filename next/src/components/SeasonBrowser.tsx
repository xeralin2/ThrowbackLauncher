...
const COL_SPANS = [
  ...
  "col-span-2 max-[40em]:col-span-1 min-[80em]:col-span-3 wide:col-span-4",
];
...
export function SeasonBrowser({
  ...
  if (seasons === null || visible === null) {
    ...
    listContent = (
      <div
        className="home-grid grid grid-cols-2 max-[40em]:grid-cols-1 min-[80em]:grid-cols-3 wide:grid-cols-4"
    ...
    listContent = (
      <div className="-mx-(--page-pad) -mb-(--page-pad) -mt-(--page-pad) flex flex-col">
        {visible.map((season) => (
      ...
      {selected ? (
        ...
        <>
          {searchable &&
            topbarSlot &&
            createPortal(
              <div className="flex min-w-0 items-center gap-2 rounded-md border border-border bg-surface-2 p-1 transition-colors focus-within:border-action">
                <svg
                  viewBox="0 0 24 24"
            ...
            createPortal(
              <div className="flex items-center gap-3">
                ...
                >
                  <EraseIcon
                    key={resetErase}
                    className={resetErase ? "animate-erase-once" : ""}
                  />
                </button>
                {(seasons?.length ?? 0) > 1 && (
                  <button

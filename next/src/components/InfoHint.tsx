...
export function InfoHint({
  ...
  return (
    ...
    >
      ...
      <span
        aria-hidden={!open}
        className={`absolute top-full z-20 mt-1.5 w-60 rounded-md border border-border bg-surface-2 px-3 py-2 text-left text-ui leading-snug text-text shadow-lg transition-opacity duration-200 ${

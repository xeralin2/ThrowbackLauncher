...
export const metadata: Metadata = FAQ_PAGES.commonErrors;
...
const faqs: FaqItem[] = [
      ...
      <>
        ...
        <ol>
          <li>
            ...
            <Link href="/faq/antivirus#q1">Antivirus page</Link> to add an
            exclusion for your library folder
          </li>
          <li>
    ...
    a: (
      <ol>
        <li>
          ...
          and removed, so make sure your library folder has an exclusion set up
          (see the <Link href="/faq/antivirus#q1">Antivirus page</Link>)
        </li>
        <li>
        ...
        <ol>
          ...
          <OnWindows>
            <li>
              ...
              <Link href="/faq/antivirus#q1">Antivirus page</Link>) and run{" "}
  ...
  },
  {
    ...
    a: (
      <>
        <p>This is usually caused by your antivirus removing it.</p>
        <ol>
          <li>
            Follow the instructions on the{" "}
            <Link href="/faq/antivirus#q1">Antivirus page</Link> to add an

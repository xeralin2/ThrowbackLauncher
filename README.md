...
1. Download `Launcher.exe` from the [latest release](https://github.com/xeralin2/ThrowbackLauncher/releases/latest)
2. Run it and pick an install folder, or keep the default `%LOCALAPPDATA%\ThrowbackLauncher`

**Linux**

1. Download `Launcher.AppImage` from the [latest release](https://github.com/xeralin2/ThrowbackLauncher/releases/latest)

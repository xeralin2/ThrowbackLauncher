...
use windows_sys::Win32::Networking::WinSock::{
    ...
    WSAStartup, FD_SET, INVALID_SOCKET, IN_ADDR, IN_ADDR_0, SOCKADDR, SOCKADDR_IN, SOCKET, TIMEVAL,
    WSADATA,
};
...
impl Runner {
    ...
    fn run(&mut self, port_file: &str) -> i32 {
        ...
        {
            let mut af: FD_SET = unsafe { zeroed() };
            af.fd_count = 1;
            af.fd_array[0] = ls;
            let tv = TIMEVAL {
                tv_sec: 20,
